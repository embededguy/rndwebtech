...
<html lang="en">
  <head>
    ...
    <title>Blog Types List | RNDWebTech</title>
    <!-- Simple bar CSS -->
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="mb-2 page-title">Blog Type <span class="fe fe-chevrons-right fe-16"></span> List</h2>
              <p class="card-text">Helps, you view all blog type</p>
              <div class="row my-4">
