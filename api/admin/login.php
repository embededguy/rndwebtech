...
<html lang="en">
  <head>
    ...
    <title>RNDWebTech - Admin Panel!!</title>
    <!-- Simple bar CSS -->
      ...
      <div class="row align-items-center h-100">
        <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST" action="./controller/process_login.php">
          <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="./index.php">
            <img src="./assets/images/rnd-logo.png" width="80%" />
          </a>
          <br/>
          <br/>
          <br/>
          ...
          <p class="mt-5 mb-3 text-muted">© VITT <script>document.write(new Date().getFullYear());</script>, Developed & Managed by RNDWebTech.</p>
        </form>
      </div>
    </div>
