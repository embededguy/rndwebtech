    ...
    <>
      ...
      >
        <div
          ...
          data-bg-opacity=".2"
        />
        <div className="section-dotted-bg" />
        <div className="animated-lines">
          <span className="animated-line line-1" />
          <span className="animated-line line-2" />
          <span className="animated-line line-3" />
          <span className="animated-line line-4" />
          <span className="animated-line line-5" />
          <span className="animated-line line-6" />
          <span className="animated-line line-7" />
          <span className="animated-line line-8" />
          <span className="animated-line line-9" />
        </div>
        <div className="container">
          <div className="row align-items-center gy-5 g-lg-0">
              ...
              <div className="hero-text-area">
                ...
                <div className="row">
                  <div className="col-12">
                    ...
                    <h1 className="hero-title bold-title">
                  ...
                  <div className="col-10">
                    <p className="hero-subtitle">
                      RNDwebtech delivers expert IT services and solutions,
                      helping businesses grow with innovation, technology, and
                      creative strategies.
                    </p>
                  </div>
                  <div className="col-12">
            ...
            {/*start of .image-area */}
            <div
              className="col-10   mx-auto col-lg-6 text-center "
              data-tilt=""
            >
            ...
            <div className="row">
              ...
              >
                <div className="text-area ">
                  ...
                  <p className=" about-text">
                    At RNDwebtech, we blend innovation, expertise, and
                    commitment to deliver solutions that exceed expectations —
                    building lasting partnerships with every project.
                  </p>
                  <div className="info-items-list">
                    <div className="row ">
                      <div className="col-12 ">
