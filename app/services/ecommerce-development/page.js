          ...
          <div className="hero-text-area centerd">
            ...
            <nav aria-label="breadcrumb ">
              <ul className="breadcrumb wow fadeInUp" data-wow-delay=".6s">
                ...
                <li className="breadcrumb-item active">E Commerce Development</li>
              </ul>
            </nav>
          </div>
        </div>
                ...
                <div className="service-content">
                  <div className="part">
                    ...
                    <p className="service-text">
                      RNDwebtech builds powerful, secure, and scalable e-commerce platforms
                      designed to maximize your online sales and deliver seamless shopping
                      experiences across all devices.
                    </p>
                    <p className="service-text">
                      From custom store design to payment integrations, we create feature-rich,
                      user-centric online stores that help you connect with customers and grow
                      ...
                      <div className="row">
                        <div className="col-12 col-md-6 mb-3">
                          <div className="img-col">
                            <img className="img-fluid" src="assets/images/services/ecommerce-dev.jpg" alt="Ecommerce Development" />
                          </div>
                        </div>
                      </div>
                    </div>
